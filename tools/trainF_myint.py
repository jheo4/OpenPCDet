...
output_root = '/home/jin/mnt/Data/KITTI/trained_models/interpolation/'
cfg_files = [
...
for width in widths:
    for intr_int in intr_ints:
        ...
        for cfg, cfg_file in zip(cfgs, cfg_files):
            output_dir = output_root + str(intr_width)+ '/' + cfg
