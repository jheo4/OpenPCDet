...
output_root = '/home/jin/mnt/Data/KITTI/retrained_models/epochs/my_inter/'
...
model_ckpt_root = "/home/jin/mnt/Data/KITTI/retrained_models/my_inter/"
# model_ckpts = [
    ...
    for intr_int in intr_ints:
        ...
        for model, model_epoch, cfg_file in zip(models, model_epochs, cfg_files):
            for epoch in range(1, add_epoch+1):
                model_ckpt = model_ckpt_root + str(intr_width) + '/' + model + '/ckpt/checkpoint_epoch_' + str(model_epoch + epoch) + '.pth'
                output_dir = output_root + str(intr_width) + '/' + model + '/' + str(epoch)
